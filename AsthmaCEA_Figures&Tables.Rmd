...
```{r, DSA, include = F}
dsa <- read_csv("C:\\Users\\Joseph\\Desktop\\Grad studies MSc and Applications\\AsthmaCEA2022\\Preliminary results\\DSAResults19.csv") 
...
p <- ggplot() + 
    ...
    coord_flip() + labs(y="Incremental Net Monetary Benefit")
...
#INMB @ WTP 150k, 50k
SP150 <- tornado_plot(SP,wtp=150000)
NP150 <- tornado_plot(NP,wtp=150000)

SP50 <- tornado_plot(SP,wtp=50000)
NP50 <- tornado_plot(NP,wtp=50000)

tp150 <- ggarrange(SP150[[2]],NP150[[2]],
               ncol=1,
               nrow=2,
               common.legend = TRUE,
               labels =c('A','B'),
...
ggsave("tornado_150_19.png", plot=tp150, 
       path="C:/Users/Joseph/Desktop/Grad studies MSc and Applications/AsthmaCEA2022/Manuscript/Figures",
       width= 11,
       height= 11,
       dpi = 300)

tp50 <- ggarrange(SP50[[2]],NP50[[2]],
               ncol=1,
               nrow=2,
               common.legend = TRUE,
               labels =c('C','D'),
...
ggsave("tornado_50_19.png", plot=tp50, 
       path="C:/Users/Joseph/Desktop/Grad studies MSc and Applications/AsthmaCEA2022/Manuscript/Figures",
       width= 11,
       height= 11,
       dpi = 300)
...
##CEA plot
```{r, CEA plot}
symb <- CEA_plot(data = resw, x = resw$deltaSP_QALYs, y = resw$deltaSP_Costs, xlab="Incremental QALY", ylab = "Incremental Cost")

noTrt <- CEA_plot(data = resw, x = resw$deltaNP_QALYs, y = resw$deltaNP_Costs, xlab="Incremental QALY", ylab = "Incremental Cost")

theme_set(theme_pubr())
y <- ggarrange(symb,noTrt,
               ncol=2,
               nrow=1,
               common.legend = TRUE,
               labels =c('A','B'),
