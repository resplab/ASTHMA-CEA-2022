...
RR.NC <- 1.193 #RR of exacerbation for not controlled asthma
  ...
  #Rate of exacerbation from controlled group
...
for (i in 2:(n.t + 1)) { 
  ...
  H0NC.rem <- min((0+0+p.H0C_SCS*RR.NC+p.H0C_ED*RR.NC+p.H0C_Hosp*RR.NC+p.H0NC_D[j]),1)
  H1C.rem <- min(((p.H1_H0*p.H0_AC)+(p.H1_H0*(1-p.H0_AC))+p.H1C_SCS+p.H1C_ED+p.H1C_Hosp+p.H1C_D[j]),1)
  H1NC.rem <- min(((p.H1_H0*p.H0_AC)+(p.H1_H0*(1-p.H0_AC))+p.H1C_SCS*RR.NC+p.H1C_ED*RR.NC+p.H1C_Hosp*RR.NC+p.H1C_D[j]),1)
  ...
  # create the transition matrix for each model cycle
    m.P <- matrix(c(
                    ...
                    (1-H0NC.rem)*p.H0_AC,(1-H0NC.rem)*(1-p.H0_AC), 0,0, p.H0C_SCS*RR.NC, p.H0C_ED*RR.NC, p.H0C_Hosp*RR.NC, p.H0NC_D[j], #H0NC 
                    p.H1_H0*p.H0_AC,p.H1_H0*(1-p.H0_AC),(1 - H1C.rem)*p.H1_AC,(1 - H1C.rem)*(1-p.H1_AC),p.H1C_SCS,p.H1C_ED,p.H1C_Hosp, p.H1C_D[j], #H1C
                    p.H1_H0*p.H0_AC,p.H1_H0*(1-p.H0_AC),(1 - H1NC.rem)*p.H1_AC,(1 - H1NC.rem)*(1-p.H1_AC),p.H1C_SCS*RR.NC,p.H1C_ED*RR.NC,p.H1C_Hosp*RR.NC, p.H1NC_D[j], #H1NC
...
H0NC.rem <- min((0+0+p.SYMC_SCS*RR.NC+p.SYMC_ED*RR.NC+p.SYMC_Hosp*RR.NC+p.H0NC_D[j]),1)
H1C.rem <- min(((p.H1_H0*p.H0_AC)+(p.H1_H0*(1-p.H0_AC))+p.H1C_SCS+p.H1C_ED+p.H1C_Hosp+p.H1C_D[j]),1)
H1NC.rem <- min(((p.H1_H0*p.H0_AC)+(p.H1_H0*(1-p.H0_AC))+p.H1C_SCS*RR.NC+p.H1C_ED*RR.NC+p.H1C_Hosp*RR.NC+p.H1C_D[j]),1)
SEV.rem <- min((p.SCS_D[j]+p.ED_D[j]+p.Hosp_D[j]+p.H0C_D[j]),1)
  ...
  # create the transition matrix for each model cycle
    m.P <- matrix(c(
                    (1-H0C.rem)*p.H0_AC,(1-H0C.rem)*(1-p.H0_AC), 0,0, p.SYMC_SCS, p.SYMC_ED, p.SYMC_Hosp, p.H0C_D[j], #H0C
                    (1-H0NC.rem)*p.H0_AC,(1-H0NC.rem)*(1-p.H0_AC), 0,0, p.SYMC_SCS*RR.NC, p.SYMC_ED*RR.NC, p.SYMC_Hosp*RR.NC, p.H0NC_D[j], #H0NC 
                    p.H1_H0*p.H0_AC,p.H1_H0*(1-p.H0_AC),(1 - H1C.rem)*p.H1_AC,(1 - H1C.rem)*(1-p.H1_AC),p.H1C_SCS,p.H1C_ED,p.H1C_Hosp, p.H1C_D[j], #H1C
                    p.H1_H0*p.H0_AC,p.H1_H0*(1-p.H0_AC),(1 - H1NC.rem)*p.H1_AC,(1 - H1NC.rem)*(1-p.H1_AC),p.H1C_SCS*RR.NC,p.H1C_ED*RR.NC,p.H1C_Hosp*RR.NC, p.H1NC_D[j], #H1NC
