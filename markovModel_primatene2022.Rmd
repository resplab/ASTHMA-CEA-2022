...
MicroSim <- function(v.M_1, n.i, n.t, v.n, d.c, d.e, TR.out = TRUE, TS.out = TRUE, Trt = FALSE, seed = 1996) {
  ...
  mortality <- read_csv("mortality.csv") #running in mortality sheet
...
tornado_plot <- function(df, wtp=100000){
  ...
  dsa_names<-c("Annual probability - Transitioning from no HCP to HCP (0%,20%)","Annual probability - Non-adherence to HCP (+/-20%)",
             "Annual rate of severe exacerbation - No OTC inhaler/IE (+/-20%)","Annual rate of severe exacerbation - Bud-form (+/-20%)", "Annual rate of severe exacerbation - HCP (+/-20%)",
             "Cost - HCP management (+/-20%)","Cost - Asthma not well-controlled day (+/-20%)","Cost of severe exacerbation - SCS use (+/-20%)","Cost of severe exacerbation - ED visit + SCS use (+/-20%)","Cost of severe exacerbation - Hospitalization (+/-20%)",
             "Inhalations per day - IE (+/-20%)","Inhalations per day - Bud-form (+/-20%)","Inhalations per day - ICS (+/-20%)","Inhalations per day - SABA (+/-20%)",
             "Disutility - Asthma not well-controlled day (+/-20%)","Disutility of severe exacerbation - SCS use (+/-20%)","Disutility of severe exacerbation - ED visit + SCS use (+/-20%)","Disutility of severe exacerbation - Hospitalization (+/-20%)","Utility - Non-exacerbation (+/-20%)")
...
write.csv(p1,"C:\\Users\\Joseph\\Desktop\\Grad studies MSc and Applications\\AsthmaCEA2022\\Preliminary results\\p1.csv")
write.csv(p2,"C:\\Users\\Joseph\\Desktop\\Grad studies MSc and Applications\\AsthmaCEA2022\\Preliminary results\\p2.csv")
write.csv(prim_agg, "C:\\Users\\Joseph\\Desktop\\Grad studies MSc and Applications\\AsthmaCEA2022\\Preliminary results\\prim_EC.csv")
...
write.csv(s1,"C:\\Users\\Joseph\\Desktop\\Grad studies MSc and Applications\\AsthmaCEA2022\\Preliminary results\\s1.csv")
write.csv(s2,"C:\\Users\\Joseph\\Desktop\\Grad studies MSc and Applications\\AsthmaCEA2022\\Preliminary results\\s2.csv")
write.csv(symb_agg, "C:\\Users\\Joseph\\Desktop\\Grad studies MSc and Applications\\AsthmaCEA2022\\Preliminary results\\symb_EC.csv")
...
sim_no_trt <- read_csv("C:/Users/Joseph/Desktop/Grad studies MSc and Applications/AsthmaCEA2022/Preliminary results/nt1.csv")
sim_PRIM <- read_csv("C:/Users/Joseph/Desktop/Grad studies MSc and Applications/AsthmaCEA2022/Preliminary results/p1.csv")
sim_SYMB <- read_csv("C:/Users/Joseph/Desktop/Grad studies MSc and Applications/AsthmaCEA2022/Preliminary results/s1.csv")

#Exac and control dataset
sim_no_trt_EC <- read_csv("C:/Users/Joseph/Desktop/Grad studies MSc and Applications/AsthmaCEA2022/Preliminary results/nt_EC.csv")
sim_PRIM_EC <- read_csv("C:/Users/Joseph/Desktop/Grad studies MSc and Applications/AsthmaCEA2022/Preliminary results/prim_EC.csv")
sim_SYMB_EC <- read_csv("C:/Users/Joseph/Desktop/Grad studies MSc and Applications/AsthmaCEA2022/Preliminary results/symb_EC.csv")
...
##total costs
totC<-c(sum(sim_no_trt$tc),sum(sim_PRIM$tc),sum(sim_SYMB$tc))
totC_pop<-totC*ext
totC_pop[2] - totC_pop[3]

##total deaths
ad<-c(352,486,248)/100000 #asthma fatality
ad[2] - ad[3]

SE <- sqrt((ad*(1-ad)/100000))

##total exac
totE<-c(sum(sim_no_trt_EC$exac),sum(sim_PRIM_EC$exac),sum(sim_SYMB_EC$exac))
totE_pop <- totE*ext 
totE_pop[2] - totE_pop[3]


exac_symb<-sum(sim_SYMB[["m.M"]]=="SCS")+sum(sim_SYMB[["m.M"]]=="ED")+sum(sim_SYMB[["m.M"]]=="Hosp")
exac_symb*5250000
