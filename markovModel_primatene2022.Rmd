...
## Transition probabilities #
  ...
  #H0
    ...
    pAnn.H0_D   <-  mortality$b_mortality                  # probability of death from no HCP management (turn into vector) - DUMMY VALUES of vector with                                                              same length as n.t, change to mortality$b_mortality
