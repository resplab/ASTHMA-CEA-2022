...
```{r, f_gen_psa_base model input parameters}
...
#Parameter dataframe
  df_psa <- data.frame(
    ...
    ### Cost and utility inputs ###
      ...
      c.PRIM     = 0.1  * 7,               # cost of primatene
      c.SYM      = 1.35 * 7,            # cost of symbicort
      c.ICS      =  c.ICS <- 5.44 * 7,               # cost of ICS
      c.SABA     = c.SABA <- 0.13 * 7,             # cost of SABA
      c.ICS_SABA = (c.ICS + c.SABA),
...
############################### Markov Model  ###########################
# The Markov function 
Markov <- function(params, v.M_1, n.t, v.n, d.c, d.e, trt=FALSE) {
# Arguments:  
...
```{r, running the model}
##################################### Run the simulation ##################################
sim_markov_no_trt <- Markov(params, v.M_1, n.t, v.n, d.c, d.e) # run for no treatment
sim_markov_PRIM    <- Markov(params, v.M_1, n.t, v.n, d.c, d.e, trt = "primatene")  # run for treatement
sim_markov_SYMB    <- Markov(params, v.M_1, n.t, v.n, d.c, d.e, trt = "symbicort")  # run for treatement
