...
## Transition probabilities 
  ...
  #SEV
    ...
    #Asthma Fataility (baseline)
      pAnn.SEV_D <-  c(0.0005, 0.0032, 0.0020) 
        p.SCS_D <- 1 - (1-pAnn.SEV_D[1])^(1/52)
    ...
    #Asthma Fataility * Spitzer OR for SABA overuse
       pAnn.SEV_D_PRIM <-  c(0.0013, 0.0083, 0.0052) 
        p.SCS_D_PRIM <- 1 - (1-pAnn.SEV_D_PRIM[1])^(1/52)
        p.ED_D_PRIM <- 1 - (1-pAnn.SEV_D_PRIM[2])^(1/52)
        p.Hosp_D_PRIM <- 1 - (1-pAnn.SEV_D_PRIM[3])^(1/52)
        p.SEV_H1 <- 1 - (p.SCS_D_PRIM + p.ED_D_PRIM + p.Hosp_D_PRIM)  # probability of Severe exacerbation to HCP management is 1 - whoever doesnt die
...
Markov <- function(v.M_1, n.t, v.n, d.c, d.e, trt = NULL) {
# Arguments:  
  ...
  m.P <- matrix(c(1-(p.H0_H1+p.H0_SCS+p.H0_ED+p.H0_Hosp+p.H0_D), p.H0_H1, p.H0_SCS, p.H0_ED, p.H0_Hosp, p.H0_D, #H0 (no hcp mgt)
                  p.H1_H0, 1 - (p.H1_H0+p.H1_SCS+p.H1_ED+p.H1_Hosp+p.H1_D), p.H1_SCS, p.H1_ED, p.H1_Hosp, p.H1_D, #H1 (hcp mgt)
                  0, 1 - (p.SCS_D_PRIM +p.ED_D_PRIM+p.Hosp_D_PRIM+p.H0_D), 0, 0, 0, p.SCS_D_PRIM+p.H0_D, #SCS
                  0, 1 - (p.SCS_D_PRIM +p.ED_D_PRIM+p.Hosp_D_PRIM+p.H0_D), 0, 0, 0, p.ED_D_PRIM+p.H0_D, #ED
                  0, 1 - (p.SCS_D_PRIM +p.ED_D_PRIM+p.Hosp_D_PRIM+p.H0_D), 0, 0, 0, p.Hosp_D_PRIM+p.H0_D, # Hosp
                  0, 0, 0, 0, 0, 1), #D
  ...
  m.P <- matrix(c(1-(p.H0_H1+p.H0_SCS+p.H0_ED+p.H0_Hosp+p.H0_D), p.H0_H1, p.SYM_SCS, p.SYM_ED, p.SYM_Hosp, p.H0_D, #H0 (no hcp mgt)
                  p.H1_H0, 1 - (p.H1_H0+p.H1_SCS+p.H1_ED+p.H1_Hosp+p.H1_D), p.H1_SCS, p.H1_ED, p.H1_Hosp, p.H1_D, #H1 (hcp mgt)
  ...
  # create vectors of utility and costs for each state
  v.c <- c((c.SYM*7 + (1- p.SYM_AC)*7*c.AU), #H0
           c.ICS_SABA*7 + c.HCP + c.timeHCP + ((1- p.H1_AC)*7*c.AU), #H1
           c.SCS, #SCS
           c.ED, #ED
           c.HOSP, #HOSP
...
m.P <- matrix(c(1-(p.H0_H1+p.H0_SCS+p.H0_ED+p.H0_Hosp+p.H0_D[j]), p.H0_H1, p.H0_SCS, p.H0_ED, p.H0_Hosp, p.H0_D[j], #H0 (no hcp mgt)
                ...
                0, 1 - (p.SCS_D+p.ED_D+p.Hosp_D+p.H0_D[j]), 0, 0, 0, p.SCS_D+p.H0_D[j], #SCS
                0, 1 - (p.SCS_D+p.ED_D+p.Hosp_D+p.H0_D[j]), 0, 0, 0, p.ED_D+p.H0_D[j], #ED
                0, 1 - (p.SCS_D+p.ED_D+p.Hosp_D+p.H0_D[j]), 0, 0, 0, p.Hosp_D+p.H0_D[j], # Hosp
                0, 0, 0, 0, 0, 1), #D
                nrow = n.s, ncol = n.s, byrow = T,
                 dimnames = list(v.n, v.n))
