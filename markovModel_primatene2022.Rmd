...
f_gen_psa_base <- function(n_sim = 1){
...
```
```{r, f_gen_psa_DSA input}
f_gen_psa_DSA <- function(n_sim = 1000, DSA = FALSE){
...
#All results
  ...
  write_csv(res,"C:\\Users\\Joseph\\Desktop\\Grad studies MSc and Applications\\AsthmaCEA2022\\Preliminary results\\PSAResults_ALLv3.csv")
  write_csv(psa,"C:\\Users\\Joseph\\Desktop\\Grad studies MSc and Applications\\AsthmaCEA2022\\Preliminary results\\PSAParams_ALLv3.csv")
...
```{r, CEA plotting}
#Importing data
res <- read_csv("C:\\Users\\Joseph\\Desktop\\Grad studies MSc and Applications\\AsthmaCEA2022\\Preliminary results\\PSAResults_ALLv3.csv")
res$ID <- rep(1:1000,3)
