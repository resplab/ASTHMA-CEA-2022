...
for (i in 2:(n.t + 1)) { 
  ...
  H0C.rem <- min((0+0+p.H0C_SCS+p.H0C_ED+p.H0C_Hosp+p.H0C_D[i-1]),1)
  H0NC.rem <- min((0+0+p.H0NC_SCS+p.H0NC_ED+p.H0NC_Hosp+p.H0NC_D[i-1]),1)
  ...
  # create the transition matrix for each model cycle
    m.P <- matrix(c(
                    (1-H0C.rem)*p.H0_AC,(1-H0C.rem)*(1-p.H0_AC), 0,0, p.H0C_SCS, p.H0C_ED, p.H0C_Hosp, p.H0C_D[i-1], #H0C
                    (1-H0NC.rem)*p.H0_AC,(1-H0NC.rem)*(1-p.H0_AC), 0,0, p.H0NC_SCS, p.H0NC_ED, p.H0NC_Hosp, p.H0NC_D[i-1], #H0NC 
                    p.H1_H0*p.H0_AC,p.H1_H0*(1-p.H0_AC),(1 - H1C.rem)*p.H1_AC,(1 - H1C.rem)*(1-p.H1_AC),p.H1C_SCS,p.H1C_ED,p.H1C_Hosp, p.H1C_D[i-1], #H1C
                    p.H1_H0*p.H0_AC,p.H1_H0*(1-p.H0_AC),(1 - H1NC.rem)*p.H1_AC,(1 - H1NC.rem)*(1-p.H1_AC),p.H1NC_SCS,p.H1NC_ED,p.H1NC_Hosp, p.H1NC_D[i-1], #H1NC
                    0, 0, (1 - SCS.rem)*p.H1_AC,(1-SCS.rem)*(1-p.H1_AC), 0, 0, 0, min(p.SCS_D_PRIM[i-1]+p.H0C_D[i-1],1), #SCS
                    0, 0, (1 - ED.rem)*p.H1_AC,(1-ED.rem)*(1-p.H1_AC), 0, 0, 0, min(p.ED_D_PRIM[i-1]+p.H0C_D[i-1],1), #ED
                    0, 0, (1 - Hosp.rem)*p.H1_AC,(1-Hosp.rem)*(1-p.H1_AC), 0, 0, 0, min(p.Hosp_D_PRIM[i-1]+p.H0C_D[i-1],1), # Hosp
                    0, 0, 0, 0, 0, 0, 0, 1), #D
...
H0C.rem <- min((0+0+p.SYMC_SCS+p.SYMC_ED+p.SYMC_Hosp+p.H0C_D[i-1]),1)
H0NC.rem <- min((0+0+p.SYMNC_SCS+p.SYMNC_ED+p.SYMNC_Hosp+p.H0NC_D[i-1]),1)
H1C.rem <- min(((p.H1_H0*p.H0_AC)+(p.H1_H0*(1-p.H0_AC))+p.H1C_SCS+p.H1C_ED+p.H1C_Hosp+p.H1C_D[i-1]),1)
H1NC.rem <- min(((p.H1_H0*p.H0_AC)+(p.H1_H0*(1-p.H0_AC))+p.H1NC_SCS+p.H1NC_ED+p.H1NC_Hosp+p.H1C_D[i-1]),1)
...
Hosp.rem <- min((p.Hosp_D[i-1]+p.H0C_D[i-1]),1)
  ...
  # create the transition matrix for each model cycle
    m.P <- matrix(c(
                    (1-H0C.rem)*p.SYM_AC,(1-H0C.rem)*(1-p.SYM_AC), 0,0, p.SYMC_SCS, p.SYMC_ED, p.SYMC_Hosp, p.H0C_D[i-1], #H0C
                    (1-H0NC.rem)*p.SYM_AC,(1-H0NC.rem)*(1-p.SYM_AC), 0,0, p.SYMNC_SCS, p.SYMNC_ED, p.SYMNC_Hosp, p.H0NC_D[i-1], #H0NC 
                    p.H1_H0*p.SYM_AC,p.H1_H0*(1-p.SYM_AC),(1 - H1C.rem)*p.H1_AC,(1 - H1C.rem)*(1-p.H1_AC),p.H1C_SCS,p.H1C_ED,p.H1C_Hosp, p.H1C_D[i-1], #H1C
                    p.H1_H0*p.SYM_AC,p.H1_H0*(1-p.SYM_AC),(1 - H1NC.rem)*p.H1_AC,(1 - H1NC.rem)*(1-p.H1_AC),p.H1NC_SCS,p.H1NC_ED,p.H1NC_Hosp, p.H1NC_D[i-1], #H1NC
                    0, 0, (1 - SCS.rem)*p.H1_AC,(1-SCS.rem)*(1-p.H1_AC), 0, 0, 0, min(p.SCS_D[i-1]+p.H0C_D[i-1],1), #SCS
                    0, 0, (1 - ED.rem)*p.H1_AC,(1-ED.rem)*(1-p.H1_AC), 0, 0, 0, min(p.ED_D[i-1]+p.H0C_D[i-1],1), #ED
                    0, 0, (1 - Hosp.rem)*p.H1_AC,(1-Hosp.rem)*(1-p.H1_AC), 0, 0, 0, min(p.Hosp_D[i-1]+p.H0C_D[i-1],1), # Hosp
                    0, 0, 0, 0, 0, 0, 0, 1), #D
                  nrow = n.s, ncol = n.s, byrow = T,
                  dimnames = list(v.n, v.n))
...
results <- list(m.TR = m.TR, tc_hat = tc_hat, te_hat = te_hat, v.dwc=v.dwc, v.dwe=v.dwe, tc=tc, te=te, vc=v.c) # store the results from the simulation in a list  
